public class GameMoves
{
	...
	public int [ ][ ] gameMoves ( int player, int board[][], int [ ] x, int y[],
			String movement )
	{
		
		ValidMove verification = new ValidMove ( ); // initialize the verification
																								// function
		...
		{
			case LEFT :
				if ( x [ 1 ] != -1 || board [ x [ 0 ] ] [ y [ 0 ] ] == emptySpace
						|| board [ x [ 0 ] ] [ y [ 0 ] - 2 ] != emptySpace )
					if ( result == 0 )
					{
		 ...
		 * 
		 * 
		 * for(i = 0; i <= 10; i++) System.out.print(i + " "); for(i = 11; i <= 15;
		 * i++) System.out.print(i); System.out.println();
		 * 
		 * for(i = 0; i <= 8; i++){ for (j = 0; j <= 16; j++){ if (board[i][j] == 1)
		 * System.out.print("O" + "|"); else if (board[i][j] == 2) //conversion from
		 * int to System.out.print("@" + "|"); //char to look prettier else
		 * System.out.print(" " + "|");
		 * 
		 * } System.out.println(i); } // end of 'print the board'
		 */
